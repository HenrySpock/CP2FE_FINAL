...
function InteractionModal({ isOpen, friendshipStatus, setFriendshipStatus, currentUser, profileUser, userData, contextUser }) {
  ...
  const handleBefriend = async () => {
    const url = `https://lgcbe.onrender.com/api/friends/request`;
  ...
  const handleUnfriend = async () => {
    ...
    try {
      const response = await fetch('https://lgcbe.onrender.com/api/friends/unfriend', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
...
const handleCancelRequest = async () => {
  ...
  try {
    const response = await fetch('https://lgcbe.onrender.com/api/friends/request', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
...
const handleFollow = async () => {
  ...
  const url = isFollowing ? 'https://lgcbe.onrender.com/api/unfollow' : 'https://lgcbe.onrender.com/api/follow';
...
const submitReport = async (complaint) => {
  ...
  try {
    ...
    const response = await fetch(`https://lgcbe.onrender.com/feedback/api/users/${profileUser}/report`, {
      method: 'POST', 
      headers: {
        'Content-Type': 'application/json',
      },
...
const handleBlock = async (blockedUserId) => {
  ...
  try {
    const response = await fetch('https://lgcbe.onrender.com/api/block', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
