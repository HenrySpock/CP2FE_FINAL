...
function Abaci() {
  ...
  const fetchProlificAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/prolific-authors');
      if (!response.ok) {
  ...
  const fetchProlificTripAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/prolific-trip-authors');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchProlificTravelogAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/prolific-travelog-authors');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchProlificPhotographers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/prolific-photographers');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostFollowedUsers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/top-followed-users');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostFollowedAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-followed-authors');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostFollowedPhotographers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-followed-photographers');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchLikedTravelers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-travelers');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json(); 
  ...
  const fetchLikedAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-authors');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchLikedTripAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-trip-authors');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchLikedTravelogAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-travelog-authors');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchLikedPhotographers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-photographers');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchTopTripTravelers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/top-trip-travelers');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchTopTravelogTravelers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/top-travelog-travelers');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostLikedTrips = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-trips');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostLikedTravelogs = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-travelogs');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchTopUsersByUniqueCountries = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/top-users-by-unique-countries');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
...
const fetchCountriesMostVisited = async () => {
  try {
    const response = await fetch('http://localhost:5000/abaci/countries-most-traveled');
    if (!response.ok) {
      throw new Error(`HTTP error! status: ${response.status}`);
    }
    const data = await response.json();
  ...
  const fetchCountriesMostWantToVisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/countries-most-want-to-visit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchCountriesMostWantToRevisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/countries-most-want-to-revisit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchCitiesVisited = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/cities-visited');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchCitiesMostWantToVisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/cities-most-want-to-visit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchCitiesMostWantToRevisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/cities-most-want-to-revisit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchSitesVisited = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/sites-visited');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchSitesMostWantToVisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/sites-most-want-to-visit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchSitesMostWantToRevisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/sites-most-want-to-revisit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchVideoGameSitesVisited = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/video-game-sites-visited');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchVideoGameSitesMostWantToVisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/video-game-sites-most-want-to-visit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchVideoGameSitesMostWantToRevisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/video-game-sites-most-want-to-revisit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchFilmSitesVisited = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/film-sites-visited');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchFilmSitesMostWantToVisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/film-sites-most-want-to-visit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchFilmSitesMostWantToRevisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/film-sites-most-want-to-revisit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchUNESCOSitesVisited = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/unesco-sites-visited');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchUNESCOSitesMostWantToVisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/unesco-sites-most-want-to-visit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchUNESCOSitesMostWantToRevisit = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/unesco-sites-most-want-to-revisit');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchEducationalTrips = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/educational-trips');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchInformativeTravelogs = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/informative-travelogs');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostEducationalAuthors = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-educational-authors');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchLongestTrips = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/longest-trips');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchDensestTrips = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/densest-trips');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchDiverseTrips = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/diverse-trips');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchDiverseTravelers = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/diverse-travelers');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchDiverseTripConversations = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/diverse-trip-conversations');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchDiverseTravelogConversations = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/diverse-travelog-conversations');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchLongestTripConversations = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/longest-trip-conversations');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchLongestTravelogConversations = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/longest-travelog-conversations');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostLikedCommenters = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-liked-commenters');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchTopLikedTripComments = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/top-liked-trip-comments');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchTopLikedTravelogComments = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/top-liked-travelog-comments');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchTopLikedImages = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/top-liked-images');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostViewedProfiles = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-viewed-profiles');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostViewedTrips = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-viewed-trips');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostViewedTravelogs = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-viewed-travelogs');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
  ...
  const fetchMostViewedImages = async () => {
    try {
      const response = await fetch('http://localhost:5000/abaci/most-viewed-images');
      if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
      }
      const data = await response.json();
