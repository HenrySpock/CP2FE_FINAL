  ...
  useEffect(() => {
    ...
    if (trip_id) {
      ...
      const fetchLikers = async () => {
        try {
          const response = await fetch(`http://localhost:5000/api/likers/trip?trip_id=${trip_id}`);
          if (!response.ok) {
   ...
   useEffect(() => {
    ...
    if (trip_id) {
      ...
      const fetchWritingLikers = async () => {
        try {
          const response = await fetch(`http://localhost:5000/api/likers/trip/writing?trip_id=${trip_id}`);
          if (!response.ok) {
  ...
  useEffect(() => {
    ...
    if (trip_id) {
      const fetchEducationalLikers = async () => {
        try {
          const response = await fetch(`http://localhost:5000/api/likers/educational-trip?trip_id=${trip_id}`);
          if (!response.ok) {
  ...
  useEffect(() => { 
    const fetchLikeStatus = async () => {
      if (userData && contextUser && trip_id) {
        try {
          const response = await fetch(`http://localhost:5000/api/likes/trip/check?user_id=${userData.user_id}&liker_id=${contextUser.user_id}&trip_id=${trip_id}`);
          if (!response.ok) {
...
useEffect(() => { 
  const fetchWritingLikeStatus = async () => {
    if (userData && contextUser && trip_id) {
      try {
        const response = await fetch(`http://localhost:5000/api/likes/writing/check?user_id=${userData.user_id}&liker_id=${contextUser.user_id}&trip_id=${trip_id}`);
        if (!response.ok) {
  ...
  useEffect(() => {
    ...
    const fetchEducationalLikeStatus = async () => {
      if (userData && contextUser && trip_id) {
        try {
          const response = await fetch(`http://localhost:5000/api/likes/educational-trip/check?user_id=${userData.user_id}&liker_id=${contextUser.user_id}&trip_id=${trip_id}`);
          if (!response.ok) {
  ...
  const toggleLike = async (user_id, liker_id, liketype) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/likes/trip', {
        method: 'POST',
        headers: {
