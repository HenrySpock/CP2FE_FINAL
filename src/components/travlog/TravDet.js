              ...
              {isEditMode ? (
                ...
                <div className='edit-slate'>
                  ...
                  <div className="form-group">
                    ...
                    <option value="">Ancient 𝗦𝗶𝘁𝗲𝘀</option>
                      <option value="Acropolis / Necropolis (ancient)">Acropolis / Necropolis (ancient)</option>
                      <option value="Aqueduct (ancient)">Aqueduct (ancient)</option>
                      <option value="Amphitheatre / Theater (ancient)">Amphitheatre / Theater (ancient)</option>
                      <option value="Catacombs / Tomb (ancient)">Catacombs / Tomb (ancient)</option>
                      <option value="Colosseum (ancient)">Colosseum (ancient)</option>
                      <option value="City (ancient)">City (ancient)</option>
                      <option value="Forum (ancient)">Forum (ancient)</option>
                      <option value="Citadel / Fortress (ancient)">Citadel / Fortress (ancient)</option>
                      <option value="Mausoleum (ancient)">Mausoleum (ancient)</option>
                      <option value="Monolith / Monument / Obelisk (ancient)">Monolith / Monument / Obelisk (ancient)</option>
                      <option value="Palace (ancient)">Palace (ancient)</option>
                      <option value="Pyramid (ancient)">Pyramid (ancient)</option>
                      <option value="Stone Circle (ancient)">Stone Circle (ancient)</option>
                      <option value="Temple (ancient)">Temple (ancient)</option>
                      <option value="Thermae (ancient)">Thermae (ancient)</option>
                      <option value="Ziggurat (ancient)">Ziggurat (ancient)</option>
                      <option value="Other Ancient Site">Other Ancent Site </option>
