...
function MapSorting({ onVisibilityChange, travelogs, trips }) {  
  ...
  const initialCategoryState = { 
    ...
    "Athletic Studio / Country Club / Gym / Pool / Sport Event": false, 
  ...
  const categories = [ 
    ...
    { value: "Athletic Studio / Country Club / Gym / Pool / Sport Event", label: "Athletic Studio / Country Club / Gym / Pool / Sport Event" },
